                ...
                <div className='Our_Mission-content'>
                    ...
                    <div className='Our_Mission-right'>
                        {OurMission.map((items, index) => {
                            return (
                                <div data-aos="fade-right" key={index} className='Our_Mission-right-content'>
                                    <p>{items.icon}</p>
                                    <h3>{items.title}</h3>
                                </div>
                            )
